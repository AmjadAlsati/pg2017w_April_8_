...
if("TRUE" STREQUAL "TRUE")
  set(apriltags2_SOURCE_PREFIX /home/amjad/Desktop/pg2017w/ros/src/cooperative_driving/apriltags2_ros/apriltags2)
  set(apriltags2_DEVEL_PREFIX /home/amjad/Desktop/pg2017w/ros/devel)
  ...
  set(apriltags2_INSTALL_PREFIX /home/amjad/Desktop/pg2017w/ros/install)
...
if(NOT "/home/amjad/Desktop/pg2017w/ros/src/cooperative_driving/apriltags2_ros/apriltags2/include " STREQUAL " ")
  set(apriltags2_INCLUDE_DIRS "")
  set(_include_dirs "/home/amjad/Desktop/pg2017w/ros/src/cooperative_driving/apriltags2_ros/apriltags2/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'apriltags2' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Danylo Malyuta <danylo.malyuta@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'apriltags2' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/amjad/Desktop/pg2017w/ros/src/cooperative_driving/apriltags2_ros/apriltags2/${idir}'.  Ask the maintainer 'Danylo Malyuta <danylo.malyuta@gmail.com>' to fix it.")
    endif()
