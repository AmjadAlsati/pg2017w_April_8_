...
class Token {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('token_id')) {
        this.token_id = initObj.token_id
      }
      else {
        this.token_id = 0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [token_id]
    bufferOffset = _serializer.uint32(obj.token_id, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [token_id]
    data.token_id = _deserializer.uint32(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.token_id !== undefined) {
      resolved.token_id = msg.token_id;
    }
    else {
      resolved.token_id = 0
    }
