...
"""autogenerated by genpy from cooperative_driving_hardware/LedValues.msg. Do not edit."""
import sys
...
class LedValues(genpy.Message):
  _md5sum = "7149f6e7328bbb637f466762bbc9f089"
  _type = "cooperative_driving_hardware/LedValues"
  _has_header = True #flag to mark the presence of a Header object
  _full_text = """# Used for distributing LED values
...
"""
  ...
  _slot_types = ['std_msgs/Header','cooperative_driving_hardware/LedValue[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = cooperative_driving_hardware.msg.LedValue()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
