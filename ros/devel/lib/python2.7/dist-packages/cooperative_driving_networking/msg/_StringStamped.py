...
"""autogenerated by genpy from cooperative_driving_networking/StringStamped.msg. Do not edit."""
import sys
...
class StringStamped(genpy.Message):
  ...
  _type = "cooperative_driving_networking/StringStamped"
  _has_header = True #flag to mark the presence of a Header object
  _full_text = """# Pendant to ROS std_msgs/String.msg but with a message header
