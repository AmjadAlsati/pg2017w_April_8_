...
def send_ether(src, dst, type, payload, interface="mon1"):
...
if __name__ == "__main__":
      ...
      # src=00-4F-62-2E-91-86, dst=00-4F-62-2E-91-A2, type=0x0800 (IP)
      ethernet_packet = [0x00, 0x4f, 0x62, 0x2e, 0x91, 0xa2, 0x00, 0x4f, 0x62,
                         0x2e, 0x91, 0x86, 0x08, 0x00]
