...
//depending on the platform, definitions change
#ifndef PLATFORM_COHDA
#ifndef PLATFORM_UNEX
#error Specify either PLATFORM_COHDA or PLATFORM_UNEX c flag in order to compile
#endif
#endif

#ifdef PLATFORM_COHDA
#ifdef PLATFORM_UNEX
#error Both PLATFORM_COHDA and PLATFORM_UNEX have been specified. Check CFLAGS or source files
#endif
#endif
...
/**
 * Function used to perform initial setup. For example,
 * when using the cohdas, before being able to receive
 * any frame, the device must be set on the right channel.
 * This function can take care of duties like this.
 *
