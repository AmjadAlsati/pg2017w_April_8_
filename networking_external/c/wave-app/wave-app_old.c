...
//	tMK2MACAddr dst_mac = { 0xff, 0xff, 0xff, 0xff, 0xff, 0xff };
	...
	tMK2MACAddr src_mac = { 0x00, 0x4f, 0x62, 0x2e, 0x91, 0x86 };
	tMK2MACAddr dst_mac = { 0x00, 0x4f, 0x62, 0x2e, 0x93, 0x7e };

	tx_options.TxCHOpts.ChannelNumber = 178;
	tx_options.TxCHOpts.Priority = MK2_PRIO_0;
	tx_options.TxCHOpts.Service = MK2_QOS_NOACK;
	tx_options.TxCHOpts.pMCS = MK2MCS_R12BPSK;
	tx_options.TxCHOpts.TxPower = 20;
	tx_options.TxCHOpts.pTxAntenna = MK2_TXANT_DEFAULT;
	tx_options.TxCHOpts.Bandwidth = MK2BW_10MHz;
